package P08_MultiThreading.L73_1_WaitNotifyThis;
...
//    private final Object lock = new Object();
    ...
    // Покупка булочки
    // Синхронизация по объекту this (это созданный объект Market)
    public synchronized void getBread() {
        while (breadCount < 1) {
            try {
                // данный метод срабатывает на this. То же самое, что и
                // this.wait()
                wait();
